...
public class EmeraldshovelItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:emeraldshovel")
	public static final Item block = null;
	public EmeraldshovelItem(DjfilmsmiModElements instance) {
		super(instance, 94);
	}
