...
public class EmeraldhoeItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:emeraldhoe")
	public static final Item block = null;
	public EmeraldhoeItem(DjfilmsmiModElements instance) {
		super(instance, 95);
	}
