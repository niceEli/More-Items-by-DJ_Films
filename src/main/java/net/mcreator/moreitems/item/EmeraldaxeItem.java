...
public class EmeraldaxeItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:emeraldaxe")
	public static final Item block = null;
	public EmeraldaxeItem(DjfilmsmiModElements instance) {
		super(instance, 93);
	}
