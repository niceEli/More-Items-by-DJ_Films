...
public class MithrilswordItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:mithrilsword")
	public static final Item block = null;
	public MithrilswordItem(DjfilmsmiModElements instance) {
		super(instance, 133);
	}
