...
public class RedstoneshovelItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:redstoneshovel")
	public static final Item block = null;
	public RedstoneshovelItem(DjfilmsmiModElements instance) {
		super(instance, 63);
	}
