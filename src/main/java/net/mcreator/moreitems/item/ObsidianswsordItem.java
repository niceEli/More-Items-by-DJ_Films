...
public class ObsidianswsordItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:obsidianswsord")
	public static final Item block = null;
	public ObsidianswsordItem(DjfilmsmiModElements instance) {
		super(instance, 144);
	}
