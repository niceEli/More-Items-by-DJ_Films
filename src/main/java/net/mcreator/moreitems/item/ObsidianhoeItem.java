...
public class ObsidianhoeItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:obsidianhoe")
	public static final Item block = null;
	public ObsidianhoeItem(DjfilmsmiModElements instance) {
		super(instance, 148);
	}
