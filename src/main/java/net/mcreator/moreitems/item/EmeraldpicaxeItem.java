...
public class EmeraldpicaxeItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:emeraldpicaxe")
	public static final Item block = null;
	public EmeraldpicaxeItem(DjfilmsmiModElements instance) {
		super(instance, 92);
	}
