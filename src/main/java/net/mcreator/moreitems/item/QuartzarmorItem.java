...
public class QuartzarmorItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:quartzarmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("djfilmsmi:quartzarmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("djfilmsmi:quartzarmor_leggings")
	public static final Item legs = null;
	@ObjectHolder("djfilmsmi:quartzarmor_boots")
	public static final Item boots = null;
	public QuartzarmorItem(DjfilmsmiModElements instance) {
		super(instance, 101);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "djfilmsmi:textures/models/armor/quartz__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
