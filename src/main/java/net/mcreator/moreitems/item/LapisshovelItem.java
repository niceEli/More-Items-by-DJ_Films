...
public class LapisshovelItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:lapisshovel")
	public static final Item block = null;
	public LapisshovelItem(DjfilmsmiModElements instance) {
		super(instance, 78);
	}
