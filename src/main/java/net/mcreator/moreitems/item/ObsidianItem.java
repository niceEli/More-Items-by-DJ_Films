...
public class ObsidianItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:obsidian_helmet")
	public static final Item helmet = null;
	@ObjectHolder("djfilmsmi:obsidian_chestplate")
	public static final Item body = null;
	@ObjectHolder("djfilmsmi:obsidian_leggings")
	public static final Item legs = null;
	@ObjectHolder("djfilmsmi:obsidian_boots")
	public static final Item boots = null;
	public ObsidianItem(DjfilmsmiModElements instance) {
		super(instance, 143);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "djfilmsmi:textures/models/armor/obsidian__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
