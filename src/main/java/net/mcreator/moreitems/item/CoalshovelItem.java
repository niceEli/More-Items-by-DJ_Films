...
public class CoalshovelItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:coalshovel")
	public static final Item block = null;
	public CoalshovelItem(DjfilmsmiModElements instance) {
		super(instance, 53);
	}
