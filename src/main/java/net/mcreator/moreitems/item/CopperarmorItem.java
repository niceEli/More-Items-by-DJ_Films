...
public class CopperarmorItem extends DjfilmsmiModElements.ModElement {
	@ObjectHolder("djfilmsmi:copperarmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("djfilmsmi:copperarmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("djfilmsmi:copperarmor_leggings")
	public static final Item legs = null;
	@ObjectHolder("djfilmsmi:copperarmor_boots")
	public static final Item boots = null;
	public CopperarmorItem(DjfilmsmiModElements instance) {
		super(instance, 29);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "djfilmsmi:textures/models/armor/copper__1_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
