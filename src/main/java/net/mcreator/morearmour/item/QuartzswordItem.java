...
public class QuartzswordItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:quartzsword")
	public static final Item block = null;
	public QuartzswordItem(MoreArmourModElements instance) {
		super(instance, 106);
	}
