...
public class RedstonpicaxeItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:redstonpicaxe")
	public static final Item block = null;
	public RedstonpicaxeItem(MoreArmourModElements instance) {
		super(instance, 61);
	}
