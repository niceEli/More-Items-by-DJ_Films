...
public class QuartzshovelItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:quartzshovel")
	public static final Item block = null;
	public QuartzshovelItem(MoreArmourModElements instance) {
		super(instance, 109);
	}
