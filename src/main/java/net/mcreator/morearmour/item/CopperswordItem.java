...
public class CopperswordItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:coppersword")
	public static final Item block = null;
	public CopperswordItem(MoreArmourModElements instance) {
		super(instance, 35);
	}
