...
public class ObsidianshovelItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:obsidianshovel")
	public static final Item block = null;
	public ObsidianshovelItem(MoreArmourModElements instance) {
		super(instance, 147);
	}
