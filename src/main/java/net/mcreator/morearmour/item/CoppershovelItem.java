...
public class CoppershovelItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:coppershovel")
	public static final Item block = null;
	public CoppershovelItem(MoreArmourModElements instance) {
		super(instance, 38);
	}
