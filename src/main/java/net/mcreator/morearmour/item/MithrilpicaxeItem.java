...
public class MithrilpicaxeItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:mithrilpicaxe")
	public static final Item block = null;
	public MithrilpicaxeItem(MoreArmourModElements instance) {
		super(instance, 134);
	}
