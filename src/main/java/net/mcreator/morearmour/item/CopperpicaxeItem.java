...
public class CopperpicaxeItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:copperpicaxe")
	public static final Item block = null;
	public CopperpicaxeItem(MoreArmourModElements instance) {
		super(instance, 36);
	}
