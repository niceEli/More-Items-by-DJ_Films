...
public class MithrilhoeItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:mithrilhoe")
	public static final Item block = null;
	public MithrilhoeItem(MoreArmourModElements instance) {
		super(instance, 137);
	}
