...
public class LapispicaxeItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:lapispicaxe")
	public static final Item block = null;
	public LapispicaxeItem(MoreArmourModElements instance) {
		super(instance, 76);
	}
