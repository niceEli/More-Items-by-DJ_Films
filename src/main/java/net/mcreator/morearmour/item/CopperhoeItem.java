...
public class CopperhoeItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:copperhoe")
	public static final Item block = null;
	public CopperhoeItem(MoreArmourModElements instance) {
		super(instance, 39);
	}
