...
public class RedstonearmorItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:redstonearmor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("more_armour:redstonearmor_chestplate")
	public static final Item body = null;
	@ObjectHolder("more_armour:redstonearmor_leggings")
	public static final Item legs = null;
	@ObjectHolder("more_armour:redstonearmor_boots")
	public static final Item boots = null;
	public RedstonearmorItem(MoreArmourModElements instance) {
		super(instance, 55);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "more_armour:textures/models/armor/redstone__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
