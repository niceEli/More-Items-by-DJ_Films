...
public class CopperaxeItem extends MoreArmourModElements.ModElement {
	@ObjectHolder("more_armour:copperaxe")
	public static final Item block = null;
	public CopperaxeItem(MoreArmourModElements instance) {
		super(instance, 37);
	}
